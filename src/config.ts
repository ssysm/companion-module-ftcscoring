...
export function GetConfigFields(
  _self: InstanceBaseExt<FMSConfig>
): SomeCompanionConfigField[] {
  console.log('GetConfigFields:' + _self.id);
  return [
    {
      type: 'textinput',
      id: 'host',
    ...
    },
    {
      ...
      default: '2024',
      tooltip:
        'The year of the event you are connecting to. This is used to determine the correct URL for the Cloud FMS.'
    },
    {
      type: 'textinput',
      id: 'eventID',
